...
var alphavantageApiBaseUrl = 'https://www.alphavantage.co/'
    ...
    siteConfig: {
      appSettings: [
        ...
        }
        {
          ...
          value: contains(deploymentEnvironment, 'dev') ? 'Development-RealCalls' : 'Production'
        }
        {
          name: 'AlphaAdvantageApiClientSettingsApiBaseUrl'
          value: alphavantageApiBaseUrl
        }
      ]
      ftpsState: 'FtpsOnly'
      minTlsVersion: '1.2'
